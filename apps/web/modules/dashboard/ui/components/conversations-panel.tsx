                    ...
                    {conversations.results.map((conversation) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={cn(
                                        "-translate-y-1/2 absolute top-1/2 left-0 h-[64%] w-1 rounded-r-full bg-neutrall-300 opacity-0 transition-opacity",
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="mt-1 flex items-center justify-between gap-2">
                                        <div className="flex w-0 grow items-center gap-1">
                                            ...
                                            <span
                                                className={cn(
                                                    "truncate min-w-0 flex-1 text-muted-foreground text-xs",
